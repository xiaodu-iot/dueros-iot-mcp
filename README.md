...
[发起授权请求（新窗口打开）](https://openapi.baidu.com/oauth/2.0/authorize?response_type=token&client_id=E0mZ7T6NYBLwqde7GKQAv2vK4zHjOqOH&redirect_uri=oob&scope=basic,dueros)
